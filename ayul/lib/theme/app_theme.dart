...
/// Implements Contemporary Medical Minimalism with Healing Earth Palette
/// for traditional medicine educational applications.
class AppTheme {
  AppTheme._();

  // Healing Earth Palette - Color Specifications
  static const Color primaryLight = Color(0xFF2D5016); // Deep sage green
  static const Color primaryVariantLight = Color(0xFF1F3A0F); // Darker sage
  ...
  static const Color accentLight = Color(0xFFFF6B35); // Vibrant saffron
  static const Color backgroundLight = Color(0xFFFAFAF9); // Warm off-white
  static const Color surfaceLight = Color(0xFFFFFFFF); // Pure white
  static const Color errorLight = Color(0xFFFF6B35); // Using accent for errors
  ...
  // Dark theme adaptations maintaining medical authority
  static const Color primaryDark = Color(0xFF4A7A2A); // Lighter sage for dark
  static const Color primaryVariantDark = Color(0xFF2D5016); // Original sage
  static const Color secondaryDark = Color(0xFFB8651A); // Lighter earth brown
  static const Color secondaryVariantDark = Color(0xFF8B4513); // Original brown
  static const Color accentDark = Color(0xFFFF8A5B); // Softer saffron
  ...
  static const Color errorDark = Color(0xFFFF8A5B); // Softer accent
  static const Color successDark = Color(0xFF66BB6A); // Lighter green
  static const Color warningDark = Color(0xFFFFD54F); // Lighter amber
  ...
  static const Color borderSubtleLight = Color(0xFFE8E8E8); // Minimal border

  static const Color textPrimaryDark = Color(0xFFFFFFFF);
  static const Color textSecondaryDark = Color(
    0xFFB3B3B3,
  ); // Medium gray for dark
  static const Color borderSubtleDark = Color(
    0xFF2A2A2A,
  ); // Minimal border for dark

  // Card and dialog colors for content hierarchy
  ...
  // Divider colors for content separation
  static const Color dividerLight = Color(0xFFE8E8E8);
  static const Color dividerDark = Color(0xFF2A2A2A);

  /// Light theme implementing Contemporary Medical Minimalism
  static ThemeData lightTheme = ThemeData(
    ...
    // AppBar theme for medical authority
    ...
    // FAB theme for context-aware actions
    ...
    // Typography for medical content readability
  ...
  /// Dark theme maintaining medical authority in low light
